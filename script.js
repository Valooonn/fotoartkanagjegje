(function () {
  ...
  const els = {
    ...
    heroKidOverlay: document.getElementById("heroKidOverlay"),
  ...
  function setMedia() {
    ...
    if (data.heroOverlayImage && els.heroKidOverlay) {
      els.heroKidOverlay.addEventListener("load", () => {
        els.heroKidOverlay.classList.add("is-visible");
      }, { once: true });
      els.heroKidOverlay.addEventListener("error", () => {
        els.heroKidOverlay.removeAttribute("src");
        els.heroKidOverlay.classList.remove("is-visible");
      }, { once: true });
      els.heroKidOverlay.src = data.heroOverlayImage;
    }
